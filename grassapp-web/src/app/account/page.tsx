      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="mt-8">
          ...
          <div className="space-y-4">
            ...
            {/* Become a Buddy Section */}
            <div className="mt-8">
              <h2 className="text-xl font-semibold mb-4">Earn With GrassApp</h2>
              <Link
                href="/become-buddy"
                className="flex items-center justify-between p-4 bg-budz-primary/10 border border-budz-primary rounded-lg hover:bg-budz-primary/20 transition-colors"
              >
                <div>
                  <div className="font-medium text-budz-primary">Become a Buddy</div>
                  <div className="text-sm text-gray-400">Deliver with GrassApp and earn money</div>
                </div>
                <ArrowLeftIcon className="w-5 h-5 rotate-180 text-budz-primary" />
              </Link>
            </div>
          </div>
        </div>
